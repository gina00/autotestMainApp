...
export const constantRoutes = [
  // 乾坤集成
  {
    ...
    children: [
      {
        path: 'subsystemMgr',
        // component: () => import('@/views/qiankun/qiankunSub'),
        name: 'nl-autotest-login',
        meta: {
          title: '子系统管理'
        }
      },
      {
        path: 'keyTableMonitor',
    ...
    // {
    //   path: '/DevOpsWebMain/autotest/baseData',
    //   name: 'app-vue-history',
    //   meta: {
    //     title: '报告管理'
    //   }
  ...
  //   },
  //   children: [{
  //     path: '/DevOpsWebMain/demo/baseconfig',
  //     // component: () => import('@/views/qiankun/qiankunSub'),
  //     name: 'nl-drainage',
  //     meta: {
  //       title: '基础数据'
  ...
  //   },
  //   {
  //     path: '/DevOpsWebMain/demo/flowExtractionCleanUp',
  //     // component: () => import('@/views/qiankun/qiankunSub'),
  //     name: 'nl-autotest',
  //     meta: {
  //       title: '引流测试首页'
...
export const asyncRoutes = [
  ...
  //     {
  //       path: 'drainageManagement',
  //       component: () => import('@/views/drainageManagement/index'),
  //       name: 'Dashboard',
  //       meta: { title: '引流管理', icon: 'dashboard', affix: true }
  //     }
  //   ]
  // },
